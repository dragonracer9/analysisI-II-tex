...
\begin{definition}{[Riemannsumme und Riemannintegral]}
    ...
    Eine Funktion $f: [a,b] \to \R$ heisst \textbf{Riemann-integrierbar}, falls es
    für jede Zerlegung $\{x_0,x_1,\ldots,x_n\}$ und jede Wahl der Stützpunkte
    $\{t_1,t_2,\ldots,t_n\}$ eine Zahl $I$ gibt, so dass
    \begin{align}
        \lim_{\max_{i=1,\ldots,n}(\Delta x_i)\to 0}\sum_{i=1}^{n}f(\xi_i)\Delta x_i = \lim_{n\to\infty, \,\Delta x_i\to 0}\sum_{i=1}^{n}f(\xi_i)\Delta x_i  =I.
    \end{align}
